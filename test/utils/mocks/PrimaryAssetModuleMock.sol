...
import { AbstractPrimaryAssetModuleExtension } from "../Extensions.sol";

contract PrimaryAssetModuleMock is AbstractPrimaryAssetModuleExtension {
    ...
    // The function below is only needed in the case of testing for the "AbstractDerivedAssetModule", in order for the Primary Asset to return a value
