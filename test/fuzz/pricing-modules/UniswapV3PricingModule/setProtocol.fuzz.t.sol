...
/**
 * @notice Fuzz tests for the function "setProtocol" of contract "UniswapV3PricingModule".
 */
contract SetProtocol_UniswapV3PricingModule_Fuzz_Test is UniswapV3PricingModule_Fuzz_Test {
    ...
    function testFuzz_Revert_setProtocol_ProtocolNotAddedToMainreg() public {
        ...
        uniV3PricingModule =
            new UniswapV3PricingModuleExtension(address(mainRegistryExtension), address(nonfungiblePositionManager));
    ...
    function testFuzz_Success_setProtocol() public {
        vm.startPrank(users.creatorAddress);
        uniV3PricingModule =
            new UniswapV3PricingModuleExtension(address(mainRegistryExtension), address(nonfungiblePositionManagerMock));
