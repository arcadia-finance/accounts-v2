...
/**
 * @notice Fuzz tests for the function "setRiskParametersOfDerivedAM" of contract "RegistryL1".
 */
contract SetRiskParametersOfDerivedAM_RegistryL1_Fuzz_Test is RegistryL1_Fuzz_Test {
    /* ///////////////////////////////////////////////////////////////
                              SETUP
    /////////////////////////////////////////////////////////////// */
    ...
    function testFuzz_Revert_setRiskParametersOfDerivedAM_NonRiskManager(
        ...
        registry_.setRiskParametersOfDerivedAM(
