...
contract GetValuesInNumeraire_RegistryL1_Fuzz_Test is RegistryL1_Fuzz_Test {
    ...
    function testFuzz_Success_getValuesInNumeraire_NumeraireIsUsd(uint32 currentTime) public {
    ...
    function testFuzz_Success_getValuesInNumeraire_NumeraireIsNotUsd(
        ...
        AssetValueAndRiskFactors[] memory actualValuesPerAsset = registry_.getValuesInNumeraire(
