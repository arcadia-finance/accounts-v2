...
contract CheckOracleSequence_RegistryL1_Fuzz_Test is RegistryL1_Fuzz_Test {
    ...
    function testFuzz_Revert_checkOracleSequence_UnknownOracle(bool direction, uint80 oracleId) public {
        // Given: An oracle not added to the "RegistryL1".
        oracleId = uint80(bound(oracleId, registry_.getOracleCounter(), type(uint80).max));
    ...
    function testFuzz_Success_checkOracleSequence_Negative_InactiveOracle(
        ...
        bool success = registry_.checkOracleSequence(oracleSequence);
