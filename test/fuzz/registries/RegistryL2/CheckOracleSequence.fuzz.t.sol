...
/**
 * @notice Fuzz tests for the function "checkOracleSequence" of contract "RegistryL2".
 */
contract CheckOracleSequence_RegistryL2_Fuzz_Test is RegistryL2_Fuzz_Test {
    /* ///////////////////////////////////////////////////////////////
                              SETUP
    /////////////////////////////////////////////////////////////// */
    ...
    function testFuzz_Revert_checkOracleSequence_UnknownOracle(bool direction, uint80 oracleId) public {
        // Given: An oracle not added to the "RegistryL2".
