...
/**
 * @notice Fuzz tests for the "ClaimReward" function (position rewards) of contract "IEStakedAerodromeAM".
 */
contract ClaimReward_Position_IEStakedAerodromeAM_Fuzz_Test is IEStakedAerodromeAM_Fuzz_Test {
