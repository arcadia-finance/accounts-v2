...
/**
 * @notice Fuzz tests for the function "checkOracleSequence" of contract "AbstractPrimaryAssetModule".
 */
contract CheckOracleSequence_AbstractPrimaryAssetModule_Fuzz_Test is AbstractPrimaryAssetModule_Fuzz_Test {
    /* ///////////////////////////////////////////////////////////////
                              SETUP
    /////////////////////////////////////////////////////////////// */
    ...
    function testFuzz_Revert_setOracles_OldOraclesActive(
        ...
        vm.expectRevert("APAM_SO: Oracle still active");
        assetModule.setOracles(asset, assetId, oracleSequenceNew);
    }
    ...
    function testFuzz_Revert_setOracles_BadSequence(
        ...
        vm.prank(users.creatorAddress);
        vm.expectRevert("APAM_SO: Bad sequence");
        assetModule.setOracles(asset, assetId, oracleSequenceNew);
    }
