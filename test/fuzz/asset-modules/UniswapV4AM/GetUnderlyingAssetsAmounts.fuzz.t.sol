...
/**
 * @notice Fuzz tests for the function "_getUnderlyingAssetsAmounts" of contract "UniswapV4AM".
 */
contract GetUnderlyingAssetsAmounts_UniswapV4AM_Fuzz_Test is UniswapV4AM_Fuzz_Test {
    ...
    function testFuzz_Success_GetUnderlyingAssetsAmounts_getFeeAmounts_Capped(
        ...
        uint256[] memory underlyingAssetsAmounts;
        {
            ...
            // And : Fee is not capped.
            feeData.desiredFee0 = bound(feeData.desiredFee0, principleInAmount0, type(uint96).max);
            feeData.desiredFee1 = bound(feeData.desiredFee1, principleInAmount1, type(uint96).max);
