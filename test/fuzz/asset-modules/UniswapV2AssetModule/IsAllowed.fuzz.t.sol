...
/**
 * @notice Fuzz tests for the function "isAllowed" of contract "UniswapV2AssetModule".
 */
contract IsAllowed_UniswapV2AssetModule_Fuzz_Test is UniswapV2AssetModule_Fuzz_Test {
    /* ///////////////////////////////////////////////////////////////
                              SETUP
    /////////////////////////////////////////////////////////////// */
    ...
    function testFuzz_Success_isAllowed_Negative_UnknownAsset(uint256 assetId) public {
        ...
        address asset = address(uniswapV2AssetModule);

        assertFalse(uniswapV2AssetModule.isAllowed(asset, assetId));
    }
        ...
        public
    {
        ...
        assertFalse(uniswapV2AssetModule.isAllowed(address(pool), assetId));
    }

    function testFuzz_Success_isAllowed_Negative_Token0NotAllowed(uint256 assetId) public {
        assertFalse(uniswapV2AssetModule.isAllowed(address(pairToken1Token3), assetId));
    }
    ...
    function testFuzz_Success_isAllowed_Negative_Token1NotAllowed(uint256 assetId) public {
        ...
        assertFalse(uniswapV2AssetModule.isAllowed(address(pairToken1Token4), assetId));
    }

    function testFuzz_Success_isAllowListed_Positive_UnderlyingAssetsAllowed(uint256 assetId) public {
        assertTrue(uniswapV2AssetModule.isAllowed(address(pairToken1Token2), assetId));
    }
