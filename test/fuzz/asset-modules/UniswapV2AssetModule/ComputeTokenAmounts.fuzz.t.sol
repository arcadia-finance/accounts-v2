...
/**
 * @notice Fuzz tests for the function "computeTokenAmounts" of contract "UniswapV2AssetModule".
 */
contract ComputeTokenAmounts_UniswapV2AssetModule_Fuzz_Test is UniswapV2AssetModule_Fuzz_Test {
    /* ///////////////////////////////////////////////////////////////
                              SETUP
    /////////////////////////////////////////////////////////////// */
    ...
    function testFuzz_Success_computeTokenAmounts_FeeOff(
        ...
        (uint256 token0AmountActual, uint256 token1AmountActual) =
            uniswapV2AssetModule.computeTokenAmounts(reserve0, reserve1, totalSupply, liquidityAmount, 0);
    ...
    function testFuzz_Success_computeTokenAmounts_FeeOn(
        ...
        (uint256 token0AmountActual, uint256 token1AmountActual) =
            uniswapV2AssetModule.computeTokenAmounts(reserve0, reserve1, totalSupply, liquidityAmount, kLast);
