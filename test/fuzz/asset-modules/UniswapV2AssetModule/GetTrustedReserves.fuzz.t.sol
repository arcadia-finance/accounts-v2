 ...
 */
contract GetTrustedReserves_UniswapV2AssetModule_Fuzz_Test is UniswapV2AssetModule_Fuzz_Test {
    /* ///////////////////////////////////////////////////////////////
                              SETUP
    /////////////////////////////////////////////////////////////// */
    ...
    function testFuzz_Success_getTrustedReserves(
        ...
        if (token0ToToken1) {
            amountOut = uniswapV2AssetModule.getAmountOut(amountIn, reserve0, reserve1);
            expectedTrustedReserve0 = reserve0 + amountIn;
            expectedTrustedReserve1 = reserve1 - amountOut;
        } else {
            amountOut = uniswapV2AssetModule.getAmountOut(amountIn, reserve1, reserve0);
        ...
        (uint256 actualTrustedReserve0, uint256 actualTrustedReserve1) =
            uniswapV2AssetModule.getTrustedReserves(address(pairToken1Token2), priceToken0, priceToken1);
