...
/**
 * @notice Fuzz tests for the function "getValue" of contract "UniswapV2AssetModule".
 */
contract GetValue_UniswapV2AssetModule_Fuzz_Test is UniswapV2AssetModule_Fuzz_Test {
    /* ///////////////////////////////////////////////////////////////
                              SETUP
    /////////////////////////////////////////////////////////////// */
    ...
    function testFuzz_Revert_getValue_Overflow(
        ...
        uniswapV2AssetModule.getValue(address(creditorUsd), address(pairToken1Token2), 0, amount);
    }
    ...
    function testFuzz_Success_getValue(
        ...
        (uint256 actualValueInUsd,,) = uniswapV2AssetModule.getValue(
