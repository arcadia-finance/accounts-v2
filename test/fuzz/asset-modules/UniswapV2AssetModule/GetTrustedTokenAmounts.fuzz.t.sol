...
/**
 * @notice Fuzz tests for the function "getTrustedTokenAmounts" of contract "UniswapV2AssetModule".
 */
contract GetTrustedTokenAmounts_UniswapV2AssetModule_Fuzz_Test is UniswapV2AssetModule_Fuzz_Test {
    ...
    function testFuzz_Success_getTrustedTokenAmounts(
        ...
        (uint256 token0AmountActual, uint256 token1AmountActual) = uniswapV2AssetModule.getTrustedTokenAmounts(
