...
/**
 * @notice Fuzz tests for the function "getValue" of contract "FloorERC1155AssetModule".
 */
contract GetValue_FloorERC1155AssetModule_Fuzz_Test is FloorERC1155AssetModule_Fuzz_Test {
    /* ///////////////////////////////////////////////////////////////
                              SETUP
    /////////////////////////////////////////////////////////////// */
    ...
    function testFuzz_Revert_getValue_Overflow(uint256 amountSft2, uint256 rateSft2ToUsd) public {
        ...
        floorERC1155AssetModule.getValue(address(creditorUsd), address(mockERC1155.sft2), 1, amountSft2);
    }
