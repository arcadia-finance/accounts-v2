...
/**
 * @notice Fuzz tests for the function "_calculateValueAndRiskFactors" of contract "WrappedAM".
 */
contract CalculateValueAndRiskFactors_AbstractWrappedAM_Fuzz_Test is AbstractWrappedAM_Fuzz_Test {
    /* ///////////////////////////////////////////////////////////////
                              SETUP
    /////////////////////////////////////////////////////////////// */
    ...
    function testFuzz_Success_calculateValueAndRiskFactors_NonZeroValueInUsd(
        ...
        (uint256 valueInUsd, uint256 collateralFactor, uint256 liquidationFactor) = wrappedAM
