...
/**
 * @notice Fuzz tests for the function "ProcessIndirectWithdrawal" of contract "UniswapV4HooksRegistry".
 */
// forge-lint: disable-next-item(unsafe-typecast)
contract ProcessIndirectWithdrawal_UniswapV4HooksRegistry_Fuzz_Test is UniswapV4HooksRegistry_Fuzz_Test {
    /* ///////////////////////////////////////////////////////////////
                              SETUP
    /////////////////////////////////////////////////////////////// */
    ...
    function testFuzz_Revert_processIndirectWithdrawal_NonRegistry(
        ...
        v4HooksRegistry.processIndirectWithdrawal(
    ...
    function testFuzz_Success_processIndirectWithdrawal_WithdrawAmountOne(
        ...
        v4HooksRegistry.processIndirectWithdrawal(address(creditorUsd), address(positionManagerV4), tokenId, 0, -1);
    ...
    function testFuzz_Success_processIndirectWithdrawal_WithdrawAmountZero_BeforeDeposit(
        ...
        vm.prank(address(registry));
        v4HooksRegistry.processIndirectWithdrawal(address(creditorUsd), address(positionManagerV4), tokenId, 0, 0);
