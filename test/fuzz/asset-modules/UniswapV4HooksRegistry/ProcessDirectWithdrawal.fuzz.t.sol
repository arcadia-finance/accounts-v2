...
/**
 * @notice Fuzz tests for the function "processDirectWithdrawal" of contract "UniswapV4HooksRegistry".
 */
contract ProcessDirectWithdrawal_UniswapV4HooksRegistry_Fuzz_Test is UniswapV4HooksRegistry_Fuzz_Test {
    /* ///////////////////////////////////////////////////////////////
                              SETUP
    /////////////////////////////////////////////////////////////// */
    ...
    function testFuzz_Revert_processDirectWithdrawal_NonRegistry(
        ...
        v4HooksRegistry.processDirectWithdrawal(creditor, asset, assetId, amount);
        vm.stopPrank();
    }
    ...
    function testFuzz_Success_processDirectWithdrawal_WithdrawAmountOne(
        ...
        v4HooksRegistry.processDirectWithdrawal(address(creditorUsd), address(positionManagerV4), tokenId, 1);
    ...
    function testFuzz_Success_processDirectWithdrawal_WithdrawAmountZero_BeforeDeposit(
        ...
        vm.prank(address(registry));
        v4HooksRegistry.processDirectWithdrawal(address(creditorUsd), address(positionManagerV4), tokenId, 0);
