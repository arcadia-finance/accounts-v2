...
contract ProcessDirectDeposit_DefaultUniswapV4AM_Fuzz_Test is DefaultUniswapV4AM_Fuzz_Test {
    ...
    function testFuzz_Revert_processDirectDeposit_NonRegistry(
        ...
        uniswapV4AM.processDirectDeposit(creditor, address(positionManagerV4), tokenId, 1);
        vm.stopPrank();
    }
    ...
    function testFuzz_Success_processDirectDeposit_DepositAmountZero_BeforeDeposit(
...

        {
            ...
            vm.prank(address(v4HooksRegistry));
            uint256 recursiveCalls =
                uniswapV4AM.processDirectDeposit(address(creditorUsd), address(positionManagerV4), tokenId, 0);
    ...
    function testFuzz_Success_processDirectDeposit_NativeToken(
        uint128 liquidity,
        int24 tickLower,
        int24 tickUpper,
        uint112 maxUsdExposureProtocol,
