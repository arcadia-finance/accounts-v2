...
/**
 * @notice Fuzz tests for the function "getValue" of contract "StandardERC4626AssetModule".
 */
contract GetValue_StandardERC4626AssetModule_Fuzz_Test is StandardERC4626AssetModule_Fuzz_Test {
    ...
    function testFuzz_Revert_getValue_Overflow(
        ...
        erc4626AssetModule.getValue(address(creditorUsd), address(ybToken1), 0, shares);
    }
    ...
    function testFuzz_Success_getValue(
        ...
        (uint256 actualValueInUsd,,) = erc4626AssetModule.getValue(address(creditorUsd), address(ybToken1), 0, shares);
