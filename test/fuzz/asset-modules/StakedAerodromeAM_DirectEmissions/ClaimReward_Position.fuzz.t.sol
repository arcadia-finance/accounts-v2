...
/**
 * @notice Fuzz tests for the "ClaimReward" function (position rewards) of contract "StakedAerodromeAM_DirectEmissions".
 */
contract ClaimReward_Position_StakedAerodromeAM_Fuzz_Test is StakedAerodromeAM_DirectEmissions_Fuzz_Test {
