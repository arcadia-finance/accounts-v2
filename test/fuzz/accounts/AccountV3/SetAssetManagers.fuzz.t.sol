...
/**
 * @notice Fuzz tests for the function "setAssetManagers" of contract "AccountV3".
 */
contract SetAssetManagers_AccountV3_Fuzz_Test is AccountV3_Fuzz_Test {
    /* ///////////////////////////////////////////////////////////////
                            TEST CONTRACTS
    /////////////////////////////////////////////////////////////// */
    ...
    function testFuzz_Success_setAssetManagers(TestParams memory testParams) public {
        ...
        vm.prank(users.accountOwner);
        accountExtension.setAssetManagers(params.assetManagers, currentStatuses, new bytes[](2));
        ...
        emit AccountV3.AssetManagerSet(users.accountOwner, address(assetManager1), params.statuses[0]);
        vm.expectEmit(address(accountExtension));
        emit AccountV3.AssetManagerSet(users.accountOwner, address(assetManager2), params.statuses[1]);
        vm.prank(users.accountOwner);
        setAssetManagers(params);

        // And: Asset Managers are set.
        assertEq(accountExtension.isAssetManager(users.accountOwner, address(assetManager1)), params.statuses[0]);
        assertEq(accountExtension.isAssetManager(users.accountOwner, address(assetManager2)), params.statuses[1]);
    }
    ...
    function setAssetManagers(SetAssetManagersParams memory params) internal {
        accountExtension.setAssetManagers(params.assetManagers, params.statuses, params.datas);
    }
}
