...
/**
 * @notice Fuzz tests for the function "getUsdValueExposureToUnderlyingAssetAfterWithdrawal" of contract "MainRegistry".
 */
contract GetUsdValueExposureToUnderlyingAssetAfterWithdrawal_MainRegistry_Fuzz_Test is MainRegistry_Fuzz_Test {
    ...
    /*//////////////////////////////////////////////////////////////
                              TESTS
    //////////////////////////////////////////////////////////////*/
    function testFuzz_Revert_getUsdValueExposureToUnderlyingAssetAfterWithdrawal_NonPricingModule(
    ...
    function testFuzz_Success_getUsdValueExposureToUnderlyingAssetAfterWithdrawal(
        ...
        bytes memory data = abi.encodeCall(
            primaryPricingModule.processIndirectWithdrawal,
            (
                address(creditorUsd),
                underlyingAsset,
                underlyingAssetId,
