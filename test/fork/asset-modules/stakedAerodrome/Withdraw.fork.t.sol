 ...
 */
contract Withdraw_StakedAerodromeAM_Fork_Test is StakedAerodromeAM_Fork_Test {
    /*///////////////////////////////////////////////////////////////
                            SET-UP FUNCTION
    ///////////////////////////////////////////////////////////////*/
    ...
    function testFork_Success_Withdraw() public {
        ...
        stakedAerodromeAM.withdraw(stablePool, lpBalance);

        // Then : LP tokens should be unstaked and returned to stakedAerodromAM
        assertEq(ERC20(stableGauge).balanceOf(address(stakedAerodromeAM)), 0);
    }
}
