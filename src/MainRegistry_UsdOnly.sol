 ...
 */
contract MainRegistry_UsdOnly is IMainRegistry, MainRegistryGuardian {
    ...
    function batchProcessDeposit(
        ...
        for (uint256 i; i < addressesLength;) {
            ...
            IPricingModule_UsdOnly(assetToAssetInformation[assetAddress].pricingModule).increaseExposure(
    ...
    function batchProcessWithdrawal(
        ...
        for (uint256 i; i < addressesLength;) {
            ...
            IPricingModule_UsdOnly(assetToAssetInformation[assetAddress].pricingModule).decreaseExposure(
                assetAddress, assetIds[i], amounts[i]
            );
    ...
    function increaseExposureUnderlyingAsset(
        ...
        IPricingModule_UsdOnly(assetToAssetInformation[underlyingAsset].pricingModule).increaseExposure(
