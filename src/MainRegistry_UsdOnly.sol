...
contract MainRegistry_UsdOnly is IMainRegistry, MainRegistryGuardian {
    ...
    function batchProcessDeposit(
        ...
        for (uint256 i; i < addressesLength;) {
            ...
            IPricingModule_UsdOnly(assetToAssetInformation[assetAddress].pricingModule).processDeposit(
    ...
    function batchProcessWithdrawal(
        ...
        for (uint256 i; i < addressesLength;) {
            ...
            IPricingModule_UsdOnly(assetToAssetInformation[assetAddress].pricingModule).processWithdrawal(
                msg.sender, assetAddress, assetIds[i], amounts[i]
            );
