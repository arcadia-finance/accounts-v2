 ...
 */
contract ActionMultiCallV9 is IActionBase, ERC721TokenReceiver {
    /* //////////////////////////////////////////////////////////////
                                STORAGE
    ////////////////////////////////////////////////////////////// */
    ...
    function claimAeroRewards(
        ...
        IStakedSlipstreamAM(assetModule).claimReward(id);
        IERC20(rewardToken).transfer(feeCollector, IERC20(rewardToken).balanceOf(address(this)) * feeShare / 10_000);
        IERC20(rewardToken).transfer(sendRewardsTo, IERC20(rewardToken).balanceOf(address(this)));
    }
    ...
    function claimV3Rewards(
        ...
        IERC20(token0).transfer(feeCollector, IERC20(token0).balanceOf(address(this)) * feeShare / 10_000);
        IERC20(token1).transfer(feeCollector, IERC20(token1).balanceOf(address(this)) * feeShare / 10_000);
