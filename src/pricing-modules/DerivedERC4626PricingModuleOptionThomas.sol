...
contract ERC4626PricingModule is DerivedPricingModule {
    ...
    function addAsset(address asset) external onlyOwner {
        ...
        exposureAssetToUnderlyingAssetsLast[0] = 0;
        ...
        returns (uint256 valueInUsd, uint256 collateralFactor, uint256 liquidationFactor)
    {
        ...
        uint256 conversionRate = _getConversionRate(asset, address(0));

        getValueInput.asset = assetToInformation[asset].underlyingAssets[0];
