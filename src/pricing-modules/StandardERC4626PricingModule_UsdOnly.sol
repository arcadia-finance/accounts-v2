 ...
 */
contract StandardERC4626PricingModule_UsdOnly is PricingModule_UsdOnly {
    ...
    {
        uint256 rateInUsd =
            IOraclesHub_UsdOnly(oracleHub).getRateInUsd(assetToInformation[getValueInput.asset].underlyingAssetOracles);
