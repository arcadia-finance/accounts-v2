...
import { PricingModule_UsdOnly, IMainRegistry } from "./AbstractPricingModule_UsdOnly.sol";
 ...
 */
contract UniswapV2PricingModule_UsdOnly is PricingModule_UsdOnly {
    ...
    ) PricingModule_UsdOnly(mainRegistry_, oracleHub_, assetType_, msg.sender) {
    ...
    function addAsset(address asset, RiskVarInput[] calldata riskVars, uint256 maxExposure) external onlyOwner {
        ...
        require(PricingModule_UsdOnly(erc20PricingModule).isAllowListed(token0, 0), "PMUV2_AA: TOKENO_NOT_WHITELISTED");
        require(PricingModule_UsdOnly(erc20PricingModule).isAllowListed(token1, 0), "PMUV2_AA: TOKEN1_NOT_WHITELISTED");
        ...
        returns (uint256 valueInUsd, uint256 collateralFactor, uint256 liquidationFactor)
    {
        ...
        (uint256 trustedUsdPriceToken0,,) = PricingModule_UsdOnly(erc20PricingModule).getValue(
            GetValueInput({
        ...
        (uint256 trustedUsdPriceToken1,,) = PricingModule_UsdOnly(erc20PricingModule).getValue(
            GetValueInput({
