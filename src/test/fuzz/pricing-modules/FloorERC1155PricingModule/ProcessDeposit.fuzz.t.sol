...
contract ProcessDeposit_FloorERC1155PricingModule_Fuzz_Test is FloorERC1155PricingModule_Fuzz_Test {
        ...
        public
    {
        ...
        floorERC1155PricingModule.processDeposit(account, address(mockERC1155.sft2), 1, amount);
        vm.stopPrank();
    }
    ...
    function testRevert_processDeposit_WrongID(uint256 assetId, uint128 amount, address account) public {
        ...
        floorERC1155PricingModule.processDeposit(account, address(mockERC1155.sft2), assetId, amount);
        vm.stopPrank();
