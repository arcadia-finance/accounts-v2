...
contract ProcessWithdrawal_FloorERC721PricingModule_Fuzz_Test is FloorERC721PricingModule_Fuzz_Test {
    ...
    function testRevert_processWithdrawal_NonMainRegistry(address unprivilegedAddress_, address account) public {
        ...
        floorERC721PricingModule.processWithdrawal(account, address(mockERC721.nft2), 1, 1);
        vm.stopPrank();
    }
    ...
    function testRevert_processWithdrawal_NotOne(uint256 assetId, address account, uint256 amount) public {
        ...
        floorERC721PricingModule.processWithdrawal(account, address(mockERC721.nft2), assetId, amount);
        vm.stopPrank();
    }
