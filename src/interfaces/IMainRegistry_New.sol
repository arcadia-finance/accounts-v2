...
import { IPricingModule_New } from "./IPricingModule_New.sol";
...
interface IMainRegistry {
    ...
    function getUsdValue(IPricingModule_New.GetValueInput memory getValueInput) external view returns (uint256);
}
